                    ...
                    <NavItem>
                        ...
                        <NavMenu>
                            <NavLinks>
                                <div class="container">
                                    <div class="btn">
                                        <span style={{ color: 'white',fontSize:'1rem' }}>Home</span>
                                    </div>
                                </div>
                            </NavLinks>
                        </NavMenu>
                        <NavMenu>
                            <NavLinks>
                                <div class="container">
                                    <div class="btn">
                                        <span style={{ color: 'white',fontSize:'1rem' }}>News</span>
                                    </div>
                                </div>
                            </NavLinks>
                        </NavMenu>
                        <NavMenu>
                            <NavLinks >
                                <div class="container">
                                    <div class="btn">
                                        <Link to='contact'><span to='contact' style={{ color: 'white',fontSize:'1rem' }}>Contact</span></Link>
                                    </div>
                                </div>
                            </NavLinks>
                        </NavMenu>
                            ...
                            <NavLinks>
                                <div class="container">
                                    <div class="btn">
                                         ...
                                         <a style={{ color: 'white',fontSize:'1rem' }}  target="_blank" href="https://valleycasa.com/preferred-lenders/" style={{ color: 'white' }}><AiFillFacebook style={{ color: 'white',fontSize:'1rem' }} /></a>
                                ...
                                <div class="container">
                                    <div class="btn">
                                        <a href="https://mobile.twitter.com/home" class="pull-left">
                                            <span style={{ color: 'white',fontSize:'1rem' }}><GrTwitter /></span>
                                        </a>
                                    </div>
                                ...
                                <div class="container">
                                    <div class="btn">
                                        <a href="https://www.instagram.com/" class="pull-left">
                                            <span style={{ color: 'white',fontSize:'1rem' }}><AiOutlineInstagram /></span>
                                        </a>
                                    </div>
                                </div>
                            </NavLinks>
